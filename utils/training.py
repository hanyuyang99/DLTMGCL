...
import os
import numpy as np
from utils.metrics import forward_transfer, forgetting, backward_transfer
...
def train(model: ContinualModel, dataset: ContinualDataset,
    ...
    # lst_ema_models = ['plastic_model', 'stable_model', 'hippo_model', 'neo_model']
    lst_ema_models = []
    ema_loggers = {}
    ema_results = {}
    ...
    for t in range(dataset.N_TASKS):
        ...
        print(results)
        print(results_mask_classes)
        print(f"Task-il Forgetting measure: {forgetting(results)}")
        # print(f"Task-il Forward Transfer measure: {forward_transfer(results)}")
        print(f"Task-il Backward Transfer measure: {backward_transfer(results)}")
        print(f"Class-il Forgetting measure: {forgetting(results_mask_classes)}")
        # print(f"Class-il Forward Transfer measure: {forward_transfer(results_mask_classes)}")
        print(f"Class-il Backward Transfer measure: {backward_transfer(results_mask_classes)}")
